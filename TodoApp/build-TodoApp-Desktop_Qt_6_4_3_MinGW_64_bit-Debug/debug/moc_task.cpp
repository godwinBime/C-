...
Q_CONSTINIT static const qt_meta_stringdata_Task_t qt_meta_stringdata_Task = {
    {
        ...
        QT_MOC_LITERAL(5, 7),  // "removed"
        QT_MOC_LITERAL(13, 0),  // ""
        QT_MOC_LITERAL(14, 5),  // "Task*"
        QT_MOC_LITERAL(20, 4),  // "task"
        QT_MOC_LITERAL(25, 13),  // "statusChanged"
        QT_MOC_LITERAL(39, 6),  // "rename"
...
void Task::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->removed((*reinterpret_cast< std::add_pointer_t<Task*>>(_a[1]))); break;
        case 1: _t->statusChanged((*reinterpret_cast< std::add_pointer_t<Task*>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Task::removed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Task::*)(Task * );
            if (_t _q_method = &Task::statusChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
