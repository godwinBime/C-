...
#ifndef CHAPTER06_MULTIPLEIMAGEWINDOW_H
#define CHAPTER06_MULTIPLEIMAGEWINDOW_H
...
public:
    ...
    MultipleImageWindow(const string& windowTitle, int cols, int rows, int flags);
    ...
    int addImage(const string& title, Mat image, bool render = false);
...
#endif //CHAPTER06_MULTIPLEIMAGEWINDOW_H
