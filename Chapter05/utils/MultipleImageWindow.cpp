...
MultipleImageWindow::MultipleImageWindow(string windowTitle, int cols, int rows, int flags) {
...
void MultipleImageWindow::render() {
	...
	//Width and height of cell. Add 10 px of ppadding between images
	...
	vector<string>::iterator titlesIterator = this->titles.begin();
